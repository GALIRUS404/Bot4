...
title: botname,
body: ownername,
thumbnailUrl: 'https://od.lk/s/OV8yMzA3Njk1MTRf/6ec361c8f42b469728ee4b9f434c612f.jpg',
sourceUrl: websitex
},
},
text: txt,
...
await XeonBotInc.sendMessage(m.chat, { video: { url: anu.result.no_watermark}, caption: ``}, {quoted: m})
await XeonBotInc.sendMessage(m.chat, { react: { text: `☑️`, key: m.key }})
}catch (error) {
